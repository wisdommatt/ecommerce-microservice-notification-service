...
func (x *EmailMessage) GetEmailAddress() string {
	if x != nil {
...
func (x *EmailMessageResponse) Reset() {
	*x = EmailMessageResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *EmailMessageResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EmailMessageResponse) ProtoMessage() {}

func (x *EmailMessageResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_email_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EmailMessageResponse.ProtoReflect.Descriptor instead.
func (*EmailMessageResponse) Descriptor() ([]byte, []int) {
	return file_proto_email_proto_rawDescGZIP(), []int{1}
}

func (x *EmailMessageResponse) GetProcessing() bool {
	if x != nil {
		return x.Processing
	}
	return false
...
var file_proto_email_proto_rawDesc = []byte{
	...
	,
...
var file_proto_email_proto_goTypes = []interface{}{
	...
	(*EmailMessageResponse)(nil), // 1: EmailMessageResponse
}
var file_proto_email_proto_depIdxs = []int32{
	0, // 0: EmailNotification.SendEmail:input_type -> EmailMessage
	1, // 1: EmailNotification.SendEmail:output_type -> EmailMessageResponse
...
func file_proto_email_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_email_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EmailMessageResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
